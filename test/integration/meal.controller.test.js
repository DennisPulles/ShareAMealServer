		...
		it('TC-301-1 Required field missing', (done) => {
			chai.request(server)
				...
				.send({
					...
					price: 5.50,
					imageUrl:
						'https://t.eu1.jwwb.nl/W682407/UYP7o9fm_Y55dSlUgrI0xDdGPu8=/0x160:1600x903/1200x557/f.eu1.jwwb.nl%2Fpublic%2Fy%2Fe%2Fp%2Ftemp-oiepihihappqmxrjsyvg%2F0w7c8x%2Fspagetti-1.jpg',
		...
		it('TC-301-3 Meal added succesfully', (done) => {
			chai.request(server)
				...
				.send({
					...
					description:
						'Italiaanse hap van deegslierten en saus!',
					isActive: 1,
					isVega: 0,
					isVegan: 0,
					isToTakeHome: 1,
